...
fun Application.module(testing: Boolean = false) {
    val todoListRepository = TodoListRepositorySQL(TodoServiceImpl())
    moduleWithDependencies(todoListRepository)

}

fun Application.moduleWithDependencies(repository: TodoListRepository){
    install(Routing){
        todoAPi(repository)
    }
