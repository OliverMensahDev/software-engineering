...
public class App {
    ...
    public static void main(String[] args){
        ...
        System.out.println("Price in USD: " + total2);
        System.out.println("Hard-coded Price in EUR: " + converter.convert(total2));
        System.out.println("From a web service Price in EUR: " + converter.convertWithWebService(total2));
