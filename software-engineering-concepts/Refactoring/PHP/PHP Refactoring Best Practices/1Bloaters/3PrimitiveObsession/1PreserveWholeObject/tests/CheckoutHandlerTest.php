...
class CheckoutHandlerTest extends TestCase
{
    ...
    public function testCalculateTotalValidVoucherGoldMembership()
    {
        ...
        $total = $this->checkout->calculateTotal($this->shoppingList, "GIMME_DISCOUNT", $this->goldCustomer);
    ...
    public function testCalculateTotalInValidVoucherGoldMembership()
    {
        ...
        $total = $this->checkout->calculateTotal($this->shoppingList, "DummyVoucher", $this->goldCustomer);
    ...
    {
        $total = $this->checkout->calculateTotal($this->shoppingList, "DummyVoucher", $this->silverCustomer);
    ...
    {
        $total = $this->checkout->calculateTotal($this->shoppingList, "DummyVoucher", new Customer("SILVER", "MyStreet 123, France"));
        $this->assertEquals($total, 4.5);
    }
